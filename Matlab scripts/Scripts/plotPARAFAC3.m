function plotPARAFAC3(X, model, stability, varExp, meanVarExp, stdVarExp, individual_mode_metadata, feature_mode_metadata, visitXlabel, usedVisits, featureOffset, title, path)
